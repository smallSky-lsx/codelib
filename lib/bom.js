/*
 * @Author: Admin_CXx
 * @Date:   2021-01-24 10:20:11
 * @Last Modified by:   Admin_CXx
 * @Last Modified time: 2021-01-30 16:08:40
 */

// 获取窗口左上角距离设备屏幕的水平、垂直距离
function getScreenLT() {
...
function url2Obj(urlStr) {
    var url = new URL(urlStr),
        ...
        searchArr = url.search.slice(1).split('&');
    searchArr.reduce(function(accumulator, item, index) {
